...
const RangeSelector_scatterWithContour = ({datasets, activeData, handleChange, open, concatScatter}) => {
        useEffect(() => {
                            ...
                            >
                                ...
                                <Col span={20}>
                                    <Slider
                                        ...
                                        value={[
                                            Math.min(...filteredDatasets.map((d) => d[name])).toExponential(),
                                            Math.max(...filteredDatasets.map((d) => d[name])).toExponential(),
                                        ]}
...
export default RangeSelector_scatterWithContour;
